...
public class Dni {
	...
	//500 230
		...
		JLabel nombre = new JLabel("Pollagorda69");
		nombre.setBounds(135, 35, 100, 25);
		v.add(nombre);
		
		JLabel nombre1 = new JLabel("acuatropatas");
		nombre1.setBounds(135, 60, 100, 25);
		v.add(nombre1);

		JLabel nombre11 = new JLabel("Tuputamadre");
		nombre11.setBounds(135, 80, 100, 25);
		v.add(nombre11);

		JLabel nombre111 = new JLabel("H");
		nombre111.setBounds(135, 103, 100, 25);
		v.add(nombre111);
		
		JLabel nombre1111 = new JLabel("14/12/2001");
		nombre1111.setBounds(135, 125, 100, 25);
		v.add(nombre1111);
